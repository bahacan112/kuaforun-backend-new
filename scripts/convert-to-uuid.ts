...
async function convertIdsToUUID() {
  ...
  try {
    ...
    const _db = _drizzle(migrationClient);
    ...
    // UUID conversion queries
    const uuidConversionQueries = [
      // 1. Drop foreign key constraints first
      `ALTER TABLE barber_shops DROP CONSTRAINT IF EXISTS barber_shops_owner_user_id_fkey;`,
      `ALTER TABLE services DROP CONSTRAINT IF EXISTS services_barber_shop_id_fkey;`,
      `ALTER TABLE services DROP CONSTRAINT IF EXISTS services_service_template_id_fkey;`,
      `ALTER TABLE barber_comments DROP CONSTRAINT IF EXISTS barber_comments_barber_shop_id_fkey;`,
      `ALTER TABLE barber_comments DROP CONSTRAINT IF EXISTS barber_comments_user_id_fkey;`,
      `ALTER TABLE barber_comment_replies DROP CONSTRAINT IF EXISTS barber_comment_replies_comment_id_fkey;`,
      `ALTER TABLE barber_comment_replies DROP CONSTRAINT IF EXISTS barber_comment_replies_user_id_fkey;`,
      `ALTER TABLE barber_comment_reply_moderations DROP CONSTRAINT IF EXISTS barber_comment_reply_moderations_reply_id_fkey;`,
      `ALTER TABLE barber_comment_reply_history DROP CONSTRAINT IF EXISTS barber_comment_reply_history_comment_id_fkey;`,
      `ALTER TABLE barber_comment_reply_history DROP CONSTRAINT IF EXISTS barber_comment_reply_history_reply_id_fkey;`,
      `ALTER TABLE barber_reviews DROP CONSTRAINT IF EXISTS barber_reviews_barber_shop_id_fkey;`,
      `ALTER TABLE barber_photos DROP CONSTRAINT IF EXISTS barber_photos_barber_shop_id_fkey;`,
      `ALTER TABLE barber_hours DROP CONSTRAINT IF EXISTS barber_hours_barber_shop_id_fkey;`,
      `ALTER TABLE shop_staff DROP CONSTRAINT IF EXISTS shop_staff_shop_id_fkey;`,
      `ALTER TABLE shop_staff DROP CONSTRAINT IF EXISTS shop_staff_auth_user_id_fkey;`,
      `ALTER TABLE staff_hours DROP CONSTRAINT IF EXISTS staff_hours_staff_id_fkey;`,
      `ALTER TABLE staff_leaves DROP CONSTRAINT IF EXISTS staff_leaves_staff_id_fkey;`,
      `ALTER TABLE user_favorite_barbers DROP CONSTRAINT IF EXISTS user_favorite_barbers_staff_id_fkey;`,
      `ALTER TABLE user_favorite_shops DROP CONSTRAINT IF EXISTS user_favorite_shops_shop_id_fkey;`,
      `ALTER TABLE bookings DROP CONSTRAINT IF EXISTS bookings_shop_id_fkey;`,
      ...
      `ALTER TABLE in_app_notifications DROP CONSTRAINT IF EXISTS in_app_notifications_user_id_fkey;`,
    ...
    for (let i = 0; i < uuidConversionQueries.length; i++) {
      ...
      console.log(`[${i + 1}/${uuidConversionQueries.length}] Executing: ${query.substring(0, 50)}...`);
